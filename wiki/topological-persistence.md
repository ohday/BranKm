---
title: "Topological Persistence for Space Segmentation"
...
随着阈值在[开阔度场](./ray-to-scalar-fields.md)中从高到低扫描：
...
### 第 1 步：标量场预处理
计算[均值开阔度 Ō](./ray-to-scalar-fields.md)并取反，使房间中心成为局部极小值（这是下水平集持久性的惯例）。
...
持久同调的合并树**就是**标记控制[分水岭](./watershed-segmentation.md)隐式构建的合并树。关键区别如下：
